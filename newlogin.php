...
<body>
        ...
        <div class="wrapper">
            <h4>
                ...
                <form action="login.php" method="post">
                    ...
                    <div>
                        <button class="button" type="submit" onclick="use()">Login</button>
                    </div>
                </form>
            </h4>
        </div>
    ...
    <div class="foot-panel4">
        <div class="pages">
            <a href="copywright.html" target="_blank">Conditions Of Use</a>
            <a href="privacy.html" target="_blank">Privacy Notice</a>
            <a href="copywright.html" target="_blank">Your Ads Privacy Choice</a>
            <div class="copywrite">
...
if (!empty($_POST['email']) && !empty($_POST['password'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if($res = true)
        echo '<script>alert("You are logged in!"); window.location.href = "loggedin.php?email=' . $email . '";</script>';
    }
} 
$conn->close();
?>
